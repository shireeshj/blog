...
**API endpoint to receive POST request**
  ...
  {% highlight shell %}
    class SnsNotificationController < ApplicationController
      ...
      def notify_ses_alarm_status
        case request_body['Type']
        when 'SubscriptionConfirmation'
          Rails.logger.error(request_body['SubscribeURL'])
        when 'Notification'
...
**Amazon Simple Notification Service**
  ...
  - **Steps to create subcription for SNS topic**
    ...
    - Choose the protocol from the list of protocols.
      - **Email**
        - Select the **Email** protocol and enter your email in the endpoint.
        - You'll receive a subscription URL on your email. Visit this URL to subscribe to the SNS topic.
      - **HTTP/HTTPS**
        - Select **HTTP** or **HTTPS** and provide the public API endpoint URL in the endpoint field.
